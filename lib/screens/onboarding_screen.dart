...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final permissions = [
      ...
      _PermissionItem(
        ...
        description: spanish
            ? 'Evita retrasos en los recordatorios en segundo plano.'
            : 'Prevents background reminders from being delayed.',
      ...
      _PermissionItem(
        ...
        description: spanish
            ? 'Permite que los eventos ocurran a la hora exacta.'
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        if (!_loading && _allGranted)
                          M3EBadge(
                            label: Text(spanish ? 'Listo' : 'Ready'),
                          ),
                      ],
                    ),
                    ...
                    _buildPermissionSection(context, permissions),
                    const Spacer(),
                    const SizedBox(height: 28),
                    M3EButton.filled(
  ...
  bool get _allGranted =>
      _notificationsGranted && _batteryGranted && _exactAlarmGranted;
}
